...
const Login = () => {
    ...
    return (
        <div className="hero mt-8 bg-transparent text-white w-4/5 mx-auto">
            <div className="hero-content w-auto flex-col lg:flex-row">
                <div data-aos="fade-right"
                    data-aos-offset="200"
                    data-aos-easing="ease-in-sine" className="text-center lg:text-left">
                    <Animation />
                </div>
                <div data-aos="fade-left"
                    data-aos-offset="200"
                    data-aos-easing="ease-in-sine" className="card shrink-0 w-full max-w-sm shadow-2xl bg-cyan-800 bg-opacity-30">
                    <form onSubmit={formHandle} className="card-body">
                        ...
                        <label className="hover:text-white hover:underline cursor-pointer mt-2">
                            <Link to='/register' className="text-white saira font-medium">Don&#39;t have an account? Sign Up</Link>
                        </label>
