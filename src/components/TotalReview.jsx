...
import RatingAni from './RatingAni';
    ...
    return (
        <section className="text-gray-100 my-24 lato">
            <div className="container  flex flex-col-reverse mx-auto lg:flex-row">
                        ...
                        <div className="flex flex-col mt-4">
                            <div className="flex items-center space-x-1">
                                ...
                                <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700">
                                    <div className="bg-green-500 h-4 w-5/6"></div>
                                </div>
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700">
                                    <div className="bg-green-500 h-4 w-4/6"></div>
                                </div>
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700">
                                    <div className="bg-green-500 h-4 w-3/6"></div>
                                </div>
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700">
                                    <div className="bg-green-500 h-4 w-2/6"></div>
                                </div>
                ...
                <div data-aos="fade-left" className="lg:w-2/5 rounded-s-2xl lg:rounded-s-none lg:rounded-r-2xl  bg-opacity-80 bg-cyan-800">
